...
1- We will first create a third map tile layer.

2- We will add the third map to the overlay object



3- Finally, we will notice that all the earthquake data and tectonic plate data are displayed on all maps of the webpage.
